...
class Salesman extends DatabaseObject{
	
	protected static $table_name="salesman";
	protected static $db_fields = array('id', 'code'  ,'balance' ,'address' ,'phone' ,'fax' ,'mobile' ,'email' ,'notes');
